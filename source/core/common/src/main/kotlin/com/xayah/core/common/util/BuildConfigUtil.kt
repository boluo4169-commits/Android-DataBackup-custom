...
/**
 * For modules, use reflection to get [com.databackup.version.BuildConfig].
 */
private fun fromBuildConfig(key: String): Any? =
    runCatching { Class.forName("com.databackup.version.BuildConfig").getField(key).get(null) }.getOrNull()
